...
btnLoginTab.addEventListener("click", () => {
  ...
  formLogin.classList.add("form-fade");
  formRegister.classList.add("d-none");
  btnLoginTab.classList.add("active");
  btnRegisterTab.classList.remove("active");
  mainTitle.textContent = "Bienvenido de vuelta";
  mainSubtitle.textContent = "Ingresá a tu cuenta para continuar";
});

btnRegisterTab.addEventListener("click", () => {
  formLogin.classList.add("d-none");
  formRegister.classList.remove("d-none");
  formRegister.classList.add("form-fade");
  btnRegisterTab.classList.add("active");
  btnLoginTab.classList.remove("active");
  mainTitle.textContent = "Unite a Bookea";
  mainSubtitle.textContent = "Creá tu cuenta y empezá a intercambiar libros";
});
  ...
  forgotLink.addEventListener("click", async (e) => {
    ...
    if (!email) {
      return mostrarAlerta(
        "warning",
        "Ingresá tu correo y después hacé clic en “¿Olvidaste tu contraseña?”."
      );
    }
    ...
    try {
      ...
      mostrarAlerta(
        "danger",
        "No pudimos enviar el correo de recuperación. Verificá el email."
      );
    }
  });
}
